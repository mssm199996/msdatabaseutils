...
public class Droit {
	...
	public boolean like(String representation) {
		if (representation == null && (this.representation == null || this.getRepresentation() == null))
			return true;

		return this.getRepresentation().replaceAll(" ", "").toUpperCase()
				.contains(representation.replaceAll(" ", "").toUpperCase());
	}
	...
	public boolean compareToTypeDroit(ITypeDroit typeDroit) {
		return this.getRepresentation().equals(typeDroit.getDesignation());
	}
}
